...
// launchDB.populateDbTourData();
// launchDB.deleteDbAny(Tour);
...
exports.aliasTop5CheapTour = function (req, res, next) {
  (req.query.sort = "-ratingsAverage,price"), (req.query.limit = "5");
...
exports.getDistances = catchAsync(async function (req, res, next) {
  ...
  if (!unit || !units.includes(unit))
    return next(new AppError("a unit must be specified i.e mi or km", 400));
  multiplier = unit === "mi" ? 0.000621 : 0.001;
