...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZnJlZGludGVrIiwiYSI6ImNsN29hemF0bTAzcjkzeG10ZGJlY2VxOGcifQ.0moMwWWo_I6kS_TeHR4HQQ";
  var map = new mapboxgl.Map({
    container: "map",
    // container ID
    style: "mapbox://styles/fredintek/cl7ob3p30001z14mzb4wdvknx",
    // style URL
    zoom: 7,
    scrollZoom: false
  });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "http://127.0.0.1:8000/api/v1/users/updatePassword" : "http://127.0.0.1:8000/api/v1/users/updateData";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
...
var stripe = Stripe("pk_test_51LeJKIKDMxf33gLq8XYiLzEOthBPDnBaDwI7sb2sC7fKWhKlf2ZBaJyjR6WaEJVwIopnCBEmnq0ZuQ3RE4Lck3HV008TWQla7K");
...
var logoutOutBtn = document.querySelector(".nav__el--logout");
